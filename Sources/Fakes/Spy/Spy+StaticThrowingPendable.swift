...
extension Spy {
    ...
    public convenience init<Success, Failure: Error>(pendingSuccess: Success) where Returning == ThrowingStaticPendable<Success, Failure> {
    ...
    public convenience init<Failure: Error>() where Returning == ThrowingStaticPendable<(), Failure> {
    ...
    public convenience init<Success, Failure: Error>(pendingFailure: Failure) where Returning == ThrowingStaticPendable<Success, Failure> {
    ...
    public convenience init<Success, Failure: Error>(success: Success) where Returning == ThrowingStaticPendable<Success, Failure> {
        self.init(.finished(.success(success)))
    }

    /// Create a throwing pendable Spy that is pre-stubbed to throw the given error.
    public convenience init<Success, Failure: Error>(failure: Failure) where Returning == ThrowingStaticPendable<Success, Failure> {
...
extension Spy {
    ...
    public func stub<Success, Failure: Error>(pendingSuccess: Success) where Returning == ThrowingStaticPendable<Success, Failure> {
        self.stub(.pending(fallback: .success(pendingSuccess)))
    }

    /// Update the pendable Spy's stub to be in a pending state.
    public func stub<Success, Failure: Error>(pendingFailure: Failure) where Returning == ThrowingStaticPendable<Success, Failure> {
    ...
    public func stub<Success, Failure: Error>(success: Success) where Returning == ThrowingStaticPendable<Success, Failure> {
    ...
    public func stub<Success, Failure: Error>(failure: Failure) where Returning == ThrowingStaticPendable<Success, Failure> {
...
extension Spy {
    ...
    ) async throws -> Success where Returning == ThrowingStaticPendable<Success, Failure> {
    ...
    public func callAsFunction<Success, Failure: Error>(
        pendingDelay: TimeInterval = PendableDefaults.delay
    ) async throws -> Success where Arguments == Void, Returning == ThrowingStaticPendable<Success, Failure> {
